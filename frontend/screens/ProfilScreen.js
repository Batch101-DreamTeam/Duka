...
// import MontserratMedium from '../res/fonts/-Medium.ttf';
        ...
        {token ? (
            ...
            <SafeAreaView style={styles.container}>
              ...
              <View style={styles.userBlock}>
                ...
                <TouchableOpacity
                  style={styles.button}
                  activeOpacity={0.8}
                  onPress={() => setModifyField(true)}
                >
                  <FontAwesome
                    style={styles.modifyContactSlidePen}
                    name="pencil"
                    size={20}
                    color={"white"}
                  />
                ...
                {!modifyField ? (
                  <Text style={styles.tel}>{profileData.contact}</Text>
                ) : (
                  <TextInput style={styles.textInput} />
                )}
              ...
              <View style={styles.descriptionBloc}>
                ...
                >
                  <FontAwesome
                    style={styles.modifyPenDescription}
                    name="pencil"
                    size={20}
                    color={"white"}
                  />
          ...
          <View style={styles.container}>
            <Text style={styles.h3}>
              Vous devez d'abord vous connecter pour accéder à ce service
            </Text>
            <Connection />
            <Inscription />
          </View>
